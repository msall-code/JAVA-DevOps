...
public class ProductController {
    ...
    // ✅ Endpoint corrigé pour correspondre à l'envoi de la Map ou du DTO
    @PutMapping("/{id}/stock/decrement")
    public ResponseEntity<ProductResponse> decrementStock(
            @PathVariable Long id,
            @RequestBody StockUpdateRequest request) { // Assure-toi que ce DTO à un champ "quantity"
        log.info("📥 [Feign] Décrémentation stock demandée pour produit ID: {} (Quantité: {})", id, request.getQuantity());
